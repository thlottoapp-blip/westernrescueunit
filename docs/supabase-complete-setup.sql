...
CREATE TABLE IF NOT EXISTS site_config (
    ...
    hotline_primary VARCHAR(50) NOT NULL DEFAULT '061-119-3342',
...
CREATE TABLE IF NOT EXISTS hero_slides (
    ...
    secondary_btn_text VARCHAR(100) DEFAULT 'โทร 061-119-3342',
    is_active BOOLEAN DEFAULT TRUE,
...
VALUES
('PCM-01', 'นายชัยยุทธ ศิริวัฒน์', 'ประธานสมาคม / หัวหน้าชุดสั่งการกู้ภัยประจิม', '061-119-3342', 'ศูนย์ใหญ่บรบือ', TRUE, '2015-06-01'),
...
VALUES (
  ...
  '061-119-3342', '081-234-5678', '1669',
...
VALUES
('ประกาศ: หน่วยกู้ภัยประจิม ย้ำเตือนประชาชน อุบัติเหตุและเจ็บป่วยฉุกเฉิน (EMS) บริการฟรี 100% ไม่มีค่าใช้จ่าย', 'สมาคมประจิมสารคาม พุทธศาสตร์สงเคราะห์ ชี้แจงเกณฑ์การให้บริการฉุกเฉิน 24 ชั่วโมง เพื่อความโปร่งใสและสร้างความมั่นใจแก่พี่น้องประชาชน', 'ตามที่สมาคมประจิมสารคาม พุทธศาสตร์สงเคราะห์ (หน่วยกู้ภัยประจิม) ได้รับการสนับสนุนจากสถาบันการแพทย์ฉุกเฉินแห่งชาติ (สพฉ.) และ รพ.บรบือ ขอประชาสัมพันธ์ว่า การรับ-ส่งผู้ป่วยฉุกเฉิน ปฐมพยาบาล และอุบัติเหตุบนท้องถนนเป็น "บริการฟรีตลอด 24 ชั่วโมง" ประชาชนสามารถโทรแจ้ง 1669 หรือ 061-119-3342 ได้ทันทีโดยไม่มีการเรียกเก็บเงินใดๆ ทั้งสิ้น', 'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?auto=format&fit=crop&w=1200&q=80', '2026-02-15', TRUE, 'ศูนย์ประชาสัมพันธ์ สมาคมประจิมสารคาม'),
