...
export const INITIAL_SITE_CONFIG: SiteConfig = {
  ...
  fee_policy_title: 'ระเบียบเกณฑ์ค่าบริการ & นโยบายช่วยเหลือฉุกเฉิน ฟรี 100%',
  fee_policy_desc: 'งานกู้ชีพการแพทย์ฉุกเฉิน 1669, อุบัติเหตุทางถนน, จับงู-สัตว์มีพิษ, ค้นหาใต้น้ำ ช่วยเหลือฟรี 100% ไม่มีค่าใช้จ่ายใดๆ สำหรับการเคลื่อนย้ายผู้ป่วยทั่วไปต่างจังหวัด คิดตามระยะทางราคาน้ำมันจริงเพื่อช่วยเหลือประชาชน',
  rescue_process_step1_title: '1. รับแจ้งเหตุฉุกเฉิน 24 ชม.',
  rescue_process_step1_desc: 'ศูนย์วิทยุสื่อสารรับแจ้งเหตุผ่านสายด่วน 061-119-3342, ระบบเว็บพอร์ทัล และเครือข่ายศูนย์ 1669 สารคาม',
  rescue_process_step2_title: '2. ตรวจสอบพิกัด & สั่งการออกเหตุ',
  rescue_process_step2_desc: 'ตรวจสอบพิกัด GPS ดาวเทียม วิเคราะห์ความรุนแรง และสั่งการชุดกู้ชีพเคลื่อนที่เร็วออกเหตุภายใน 2 นาที',
  rescue_process_step3_title: '3. ปฏิบัติการกู้ชีพ & ปฐมพยาบาล',
  rescue_process_step3_desc: 'ทีม EMT-B เข้าถึงจุดเกิดเหตุ ดำเนินการตัด-ถ่าง ปฐมพยาบาลขั้นสูง และประเมินสัญญาณชีพอัตโนมัติ',
  rescue_process_step4_title: '4. นำส่งโรงพยาบาลปลายทางปลอดภัย',
  rescue_process_step4_desc: 'ลำเลียงผู้บาดเจ็บส่ง รพ.บรบือ / รพ.มหาสารคาม พร้อมประสานห้องฉุกเฉิน ER แบบไร้รอยต่อ',
  affiliations_marquee_text: 'เครือข่ายความร่วมมือและมาตรฐานการปฏิบัติการฉุกเฉิน: สพฉ. 1669 • กรมป้องกันและบรรเทาสาธารณภัย (ปภ.) • กระทรวงสาธารณสุข • สภ.บรบือ 191 • ชุดประดาน้ำค้นหาใต้น้ำ',
};
